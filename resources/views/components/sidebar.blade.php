<aside
    ...
    <hr class="border-gray-200 my-3 hidden md:block">
    ...
    {{-- GAP-6 (lebih lega), padding nyaman (py-3) --}}
    ...
    <div class="px-3 py-4 mt-auto">
        <form action="{{ route('logout') }}" method="POST">
            ...
            <button type="submit"
                ...
                class="flex w-full items-center gap-4 px-4 py-3 rounded-lg 
                       hover:bg-gray-100 text-red-600 transition-all duration-200">
